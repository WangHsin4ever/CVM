...
library(emo)
```
####[`r emo::ji("sparkler")`想看預告片可以點我](https://youtu.be/DU6CV7a9jjY) 
...
```
<br><hr>
####[`r emo::ji("sparkler")`第一集影片底加](https://youtu.be/sBOMTbYjfzI) 
...
####[`r emo::ji("sparkler")`第二集影片底加](https://youtu.be/kc7u6PLu7us)
...
```{r M1, eval=FALSE, results='asis', tidy=FALSE}
...
####[`r emo::ji("sparkler")`第三集影片底加](https://youtu.be/woZZNYyyyBc)
